          ...
          <div className="flex items-center justify-center gap-6 text-blue-100">
            <div className="flex items-center gap-2">
              ...
              <span>
                ...
                disponível{events.length !== 1 ? "eis" : ""}
              </span>
            </div>
          </div>
        </div>
        ...
        {events.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 max-w-md mx-auto">
              Fique atento! Novos eventos estão sempre sendo adicionados. Volte
              em breve para conferir as próximas oportunidades.
            </p>
          </div>
        ) : (
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-300">
              Cada evento é uma oportunidade única de crescimento pessoal e
              profissional. Não perca a chance de fazer parte dessa jornada de
              transformação.
            </p>
          </div>
        </div>
